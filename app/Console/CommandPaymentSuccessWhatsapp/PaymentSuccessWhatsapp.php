...
class PaymentSuccessWhatsapp extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:payment-success-whatsapp {--registration_id=0} {--notification_job_queue_id=0} {--limit=10000}';
    ...
    public function handle()
    {
      ...
      if($notification_job_queue_id != 0){ 
        ...
        ->where('notification_job_queue_type', 'payment-success-whatsapp')
