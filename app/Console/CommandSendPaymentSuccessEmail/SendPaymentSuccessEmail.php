...
namespace App\Console\CommandSendPaymentSuccessEmail;
...
class SendPaymentSuccessEmail extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:send-payment-success-email {--notification_job_queue_id=0} {--registration_id=0} {--limit=100000}';
    ...
    public function handle()
    {
        ...
        if($notification_job_queue_id != 0 ){
          ...
          ->where('notification_job_queue_type', 'payment-success-email')
     ...
     public function sendEmail($notification)
     {
         ...
         ->where('email_template_id',$registration_data['payment_email_template_id'])    
         ->first();
