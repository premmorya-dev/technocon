<x-default-layout>
    ...
    @section('breadcrumbs')
    {{ Breadcrumbs::render('student_registration.edit') }}
    @endsection



    <form action="{{ route('student_registration.update',['student_registration_id'=> $data['student_registration']['registration_id']]) }}"  class="row g-3" method="post" novalidate enctype="multipart/form-data" autocomplete="on" novalidate name="add-user">
        @csrf
        @method('put')

        <div class="col-md-12">
            <label for="program_id" class="form-label">Workshop</label>
            <select id="program_id" value="{{ old('program_id') }}" name="program_id" class="form-select">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="first_name" value="{{ old('first_name',$data['student_registration']['first_name']) }}" class="form-control" id="first_name">
            @error('first_name')
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="last_name" value="{{ old('last_name',$data['student_registration']['last_name']) }}" class="form-control" id="last_name">
            @error('last_name')
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="registered_email" value="{{ old('registered_email',$data['student_registration']['registered_email']) }}" class="form-control" id="registered_email">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="registered_email_alias" value="{{ old('registered_email_alias',$data['student_registration']['registered_email_alias']) }}" class="form-control" id="registered_email_alias">
        ...
        <div class="col-md-3">
            ...
            <select id="country_code" value="{{ old('country_code',$data['student_registration']['country_code']) }}" name="country_code" class="form-select">
        ...
        <div class="col-md-9">
            ...
            <input type="text"   name="contact" value="{{ old('contact',$data['student_registration']['contact']) }}" class="form-control" id="contact">
            @error('contact')
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="college" value="{{ old('college',$data['student_registration']['college']) }}" class="form-control" id="college">
            @error('college')
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="city" value="{{ old('city',$data['student_registration']['city']) }}" class="form-control" id="city">
            @error('city')
        ...
        <div class="col-md-12">
            ...
            <select id="country_id" value="{{ old('country_id',$data['student_registration']['country_id']) }}" name="country_id" class="form-select">
        ...
        <div class="col-md-12">
            ...
            <select id="country_state_id" value="{{ old('country_state_id',$data['student_registration']['country_state_id']) }}" name="country_state_id" class="form-select">
                     <option value=""><-- Select Country --> </option>
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="registration_number" value="{{ old('registration_number',$data['student_registration']['registration_number']) }}" class="form-control" id="registration_number">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="auto_login_string" value="{{ old('auto_login_string',$data['student_registration']['auto_login_string']) }}" class="form-control" id="auto_login_string">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="shortcode" value="{{ old('shortcode',$data['student_registration']['shortcode']) }}" class="form-control" id="shortcode">
            @error('shortcode')
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="direct_login_url" value="{{ old('direct_login_url',$data['student_registration']['direct_login_url']) }}" class="form-control" id="direct_login_url">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="direct_login_short_url" value="{{ old('direct_login_short_url',$data['student_registration']['direct_login_short_url']) }}" class="form-control" id="direct_login_short_url">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="direct_login_qr_code_url" value="{{ old('direct_login_qr_code_url',$data['student_registration']['direct_login_qr_code_url']) }}" class="form-control" id="direct_login_qr_code_url">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="direct_payment_url" value="{{ old('direct_payment_url',$data['student_registration']['direct_payment_url']) }}" class="form-control" id="direct_payment_url">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="direct_payment_short_url" value="{{ old('direct_payment_short_url',$data['student_registration']['direct_payment_short_url']) }}" class="form-control" id="direct_payment_short_url">
        ...
        <div class="col-md-12">
            ...
            <input type="number"   name="seats" value="{{ old('seats',$data['student_registration']['seats']) }}" class="form-control" id="seats">
            @error('seats')
        ...
        <div class="col-md-12">
            ...
            <input type="number"   name="amount" value="{{ old('amount',$data['student_registration']['amount']) }}" class="form-control" id="amount">
            @error('amount')
        ...
        <div class="col-md-12">
            ...
            <input type="number"   name="tax_amount" value="{{ old('tax_amount',$data['student_registration']['tax_amount']) }}" class="form-control" id="tax_amount">
            @error('tax_amount')
        ...
        <div class="col-md-12">
            ...
            <input type="number"   name="payment_gateway_fee" value="{{ old('payment_gateway_fee',$data['student_registration']['payment_gateway_fee']) }}" class="form-control" id="payment_gateway_fee">
        ...
        <div class="col-md-12">
            ...
            <input type="number"   name="total_fee_all_inclusive" value="{{ old('total_fee_all_inclusive',$data['student_registration']['total_fee_all_inclusive']) }}" class="form-control" id="total_fee_all_inclusive">
        ...
        <div class="col-md-12">
            ...
            <select id="payment_status_id" value="{{ old('payment_status_id',$data['student_registration']['payment_status_id']) }}" name="payment_status_id" class="form-select">
                     <option value=""><-- Select Country --> </option>
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="payment_id" value="{{ old('payment_id',$data['student_registration']['payment_id']) }}" class="form-control" id="payment_id">
            @error('payment_id')
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="order_id" value="{{ old('order_id',$data['student_registration']['order_id']) }}" class="form-control" id="order_id">
            @error('order_id')
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="payment_gateway_id" value="{{ old('payment_gateway_id',$data['student_registration']['payment_gateway_id']) }}" class="form-control" id="payment_gateway_id">
        ...
        <div class="col-md-12">
            ...
            <select id="razorpay_webhook_status" value="{{ old('razorpay_webhook_status',$data['student_registration']['razorpay_webhook_status']) }}" name="razorpay_webhook_status" class="form-select">
                     <option value=""><-- Select Country --> </option>                    
        ...
        <div class="col-md-12">
            ...
            <select id="currency_id" value="{{ old('currency_id',$data['student_registration']['currency_id']) }}" name="currency_id" class="form-select">
                     <option value=""><-- Select Country --> </option>
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="payment_timestamp" value="{{ old('payment_timestamp',$data['student_registration']['payment_timestamp']) }}" class="form-control" id="payment_timestamp">
        ...
        <div class="col-md-12">
            ...
            <select id="student_selection_status_id" value="{{ old('student_selection_status_id') }}" name="student_selection_status_id" class="form-select">
        ...
        <div class="col-md-12">
            ...
            <select id="student_invitation_status_id" value="{{ old('student_invitation_status_id') }}" name="student_invitation_status_id" class="form-select">
                <option value=""><-- Status --> </option>
        ...
        <div class="col-md-12">
            ...
            <div class="date-input-wrapper">
                <input type="text" name="last_date" value="{{ old('last_date',$data['student_registration']['last_date']) }}" class="form-control" id="last_date" placeholder="yyyy-mm-dd">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="venue_id" value="{{ old('venue_id',$data['student_registration']['venue_id']) }}" class="form-control" id="venue_id">
            @error('venue_id')
        ...
        <div class="col-md-12">
            ...
            <input type="time"   name="timing" value="{{ old('timing',$data['student_registration']['timing']) }}" class="form-control" id="timing">
            @error('timing')
        ...
        <div class="col-md-12">
            ...
            <select id="student_certificate_status_id" value="{{ old('student_certificate_status_id') }}" name="student_certificate_status_id" class="form-select">
                <option value=""><-- Status --> </option>
        ...
        <div class="col-md-12">
            ...
            <select id="certificate_print_status" value="{{ old('certificate_print_status',$data['student_registration']['certificate_print_status']) }}" name="certificate_print_status" class="form-select">
                     <option value=""><-- Select Country --> </option>                    
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="certificate_title" value="{{ old('certificate_title',$data['student_registration']['certificate_title']) }}" class="form-control" id="certificate_title">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="certificate_code" value="{{ old('certificate_code',$data['student_registration']['certificate_code']) }}" class="form-control" id="certificate_code">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="referrer" value="{{ old('referrer',$data['student_registration']['referrer']) }}" class="form-control" id="referrer">
            @error('referrer')
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="utm_source" value="{{ old('utm_source',$data['student_registration']['utm_source']) }}" class="form-control" id="utm_source">
            @error('utm_source')
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="utm_medium" value="{{ old('utm_medium',$data['student_registration']['utm_medium']) }}" class="form-control" id="utm_medium">
            @error('utm_medium')
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="utm_campaign" value="{{ old('utm_campaign',$data['student_registration']['utm_campaign']) }}" class="form-control" id="utm_campaign">
            @error('utm_campaign')
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="utm_term" value="{{ old('utm_term',$data['student_registration']['utm_term']) }}" class="form-control" id="utm_term">
            @error('utm_term')
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="utm_content" value="{{ old('utm_content',$data['student_registration']['utm_content']) }}" class="form-control" id="utm_content">
            @error('utm_content')
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="full_url" value="{{ old('full_url',$data['student_registration']['full_url']) }}" class="form-control" id="full_url">
            @error('full_url')
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="zoik_app_workshop_list_subscriber_uid" value="{{ old('zoik_app_workshop_list_subscriber_uid',$data['student_registration']['zoik_app_workshop_list_subscriber_uid']) }}" class="form-control" id="zoik_app_workshop_list_subscriber_uid">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="zoik_app_common_list_subscriber_uid" value="{{ old('zoik_app_common_list_subscriber_uid',$data['student_registration']['zoik_app_common_list_subscriber_uid']) }}" class="form-control" id="zoik_app_common_list_subscriber_uid">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="registration_update_url_on_zoik_app" value="{{ old('registration_update_url_on_zoik_app',$data['student_registration']['registration_update_url_on_zoik_app']) }}" class="form-control" id="registration_update_url_on_zoik_app">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="whatsapp_api_log_registration_success" value="{{ old('whatsapp_api_log_registration_success',$data['student_registration']['whatsapp_api_log_registration_success']) }}" class="form-control" id="whatsapp_api_log_registration_success">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="whatsapp_api_log_payment_success" value="{{ old('whatsapp_api_log_payment_success',$data['student_registration']['whatsapp_api_log_payment_success']) }}" class="form-control" id="whatsapp_api_log_payment_success">
        ...
        <div class="col-md-12">
            ...
            <select id="whatsapp_optin" value="{{ old('whatsapp_optin',$data['student_registration']['whatsapp_optin']) }}" name="whatsapp_optin" class="form-select">
                     <option value=""><-- Select --> </option>                    
        ...
        <div class="col-md-12">
            ...
            <div class="date-input-wrapper">
                <input type="text" name="whatsapp_optout_datetime" value="{{ old('whatsapp_optout_datetime',$data['student_registration']['whatsapp_optout_datetime']) }}" class="form-control" id="whatsapp_optout_datetime" placeholder="yyyy-mm-dd">
                <i class="fas fa-calendar-alt"></i>
            </div>
        ...
        <div class="col-md-12">
            ...
            <div class="date-input-wrapper">
                <input type="text" name="whatsapp_re_optin_datetime" value="{{ old('whatsapp_re_optin_datetime',$data['student_registration']['whatsapp_re_optin_datetime']) }}" class="form-control" id="whatsapp_re_optin_datetime" placeholder="yyyy-mm-dd">
                <i class="fas fa-calendar-alt"></i>
            </div>
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="whatsapp_optout_webbook_log" value="{{ old('whatsapp_optout_webbook_log',$data['student_registration']['whatsapp_optout_webbook_log']) }}" class="form-control" id="whatsapp_optout_webbook_log">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="whatsapp_re_optin_webbook_log" value="{{ old('whatsapp_re_optin_webbook_log',$data['student_registration']['whatsapp_re_optin_webbook_log']) }}" class="form-control" id="whatsapp_re_optin_webbook_log">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="whatsapp_optout_notification_api_log" value="{{ old('whatsapp_optout_notification_api_log',$data['student_registration']['whatsapp_optout_notification_api_log']) }}" class="form-control" id="whatsapp_optout_notification_api_log">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="whatsapp_re_optin_notification_api_log" value="{{ old('whatsapp_re_optin_notification_api_log',$data['student_registration']['whatsapp_re_optin_notification_api_log']) }}" class="form-control" id="whatsapp_re_optin_notification_api_log">
        ...
        <div class="col-md-12">
            ...
            <select id="student_registration_status_id" name="student_registration_status_id" class="form-select">
                <option value=""><-- Status --> </option>
        ...
        <div class="col-md-12">
            ...
            <div class="date-input-wrapper">
                <input type="text" name="send_reg_notification_cron_start_datetime" value="{{ old('send_reg_notification_cron_start_datetime',$data['student_registration']['send_reg_notification_cron_start_datetime']) }}" class="form-control" id="send_reg_notification_cron_start_datetime" placeholder="yyyy-mm-dd">
                <i class="fas fa-calendar-alt"></i>
            </div>
        ...
        <div class="col-md-12">
            ...
            <select id="send_reg_notification_cron_status" value="{{ old('send_reg_notification_cron_status',$data['student_registration']['send_reg_notification_cron_status']) }}" name="send_reg_notification_cron_status" class="form-select">
                     <option value=""><-- Select --> </option>                    
        ...
        <div class="col-md-12">
            ...
            <div class="date-input-wrapper">
                <input type="text" name="send_reg_notification_cron_end_datetime" value="{{ old('send_reg_notification_cron_end_datetime',$data['student_registration']['send_reg_notification_cron_end_datetime']) }}" class="form-control" id="send_reg_notification_cron_end_datetime" placeholder="yyyy-mm-dd">
                <i class="fas fa-calendar-alt"></i>
            </div>
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="send_reg_notification_cron_log" value="{{ old('send_reg_notification_cron_log',$data['student_registration']['send_reg_notification_cron_log']) }}" class="form-control" id="send_reg_notification_cron_log">
        ...
        <div class="col-md-12">
            ...
            <select id="zoik_app_registration_sync_cron_status" value="{{ old('zoik_app_registration_sync_cron_status',$data['student_registration']['zoik_app_registration_sync_cron_status']) }}" name="zoik_app_registration_sync_cron_status" class="form-select">
                     <option value=""><-- Select --> </option>                    
        ...
        <div class="col-md-12">
            ...
            <div class="date-input-wrapper">
                <input type="text" name="zoik_app_registration_sync_cron_start_datetime" value="{{ old('zoik_app_registration_sync_cron_start_datetime',$data['student_registration']['zoik_app_registration_sync_cron_start_datetime']) }}" class="form-control" id="zoik_app_registration_sync_cron_start_datetime" placeholder="yyyy-mm-dd">
                <i class="fas fa-calendar-alt"></i>
            </div>
        ...
        <div class="col-md-12">
            ...
            <div class="date-input-wrapper">
                <input type="text" name="zoik_app_registration_sync_cron_end_datetime" value="{{ old('zoik_app_registration_sync_cron_end_datetime',$data['student_registration']['zoik_app_registration_sync_cron_end_datetime']) }}" class="form-control" id="zoik_app_registration_sync_cron_end_datetime" placeholder="yyyy-mm-dd">
                <i class="fas fa-calendar-alt"></i>
            </div>
        ...
        <div class="col-md-12">
            ...
            <select id="sms_cron_status" value="{{ old('sms_cron_status',$data['student_registration']['sms_cron_status']) }}" name="sms_cron_status" class="form-select">
                     <option value=""><-- Select --> </option>                    
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="sms_cron_status_log" value="{{ old('sms_cron_status_log',$data['student_registration']['sms_cron_status_log']) }}" class="form-control" id="sms_cron_status_log">
        ...
        <div class="col-md-12">
            ...
            <select id="email_cron_status" value="{{ old('email_cron_status',$data['student_registration']['email_cron_status']) }}" name="email_cron_status" class="form-select">
                     <option value=""><-- Select --> </option>                    
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="email_cron_status_log" value="{{ old('email_cron_status_log',$data['student_registration']['email_cron_status_log']) }}" class="form-control" id="email_cron_status_log">
        ...
        <div class="col-md-12">
            ...
            <select id="whatsapp_cron_status" value="{{ old('whatsapp_cron_status',$data['student_registration']['whatsapp_cron_status']) }}" name="whatsapp_cron_status" class="form-select">
                     <option value=""><-- Select --> </option>                    
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="whatsapp_cron_status_log" value="{{ old('whatsapp_cron_status_log',$data['student_registration']['whatsapp_cron_status_log']) }}" class="form-control" id="whatsapp_cron_status_log">
        ...
        <div class="col-md-12">
            ...
            <select id="email_status" value="{{ old('email_status',$data['student_registration']['email_status']) }}" name="email_status" class="form-select">
                     <option value=""><-- Select --> </option>                    
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="email_bounce_log" value="{{ old('email_bounce_log',$data['student_registration']['email_bounce_log']) }}" class="form-control" id="email_bounce_log">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="email_bounce_datetime" value="{{ old('email_bounce_datetime',$data['student_registration']['email_bounce_datetime']) }}" class="form-control" id="email_bounce_datetime">
        ...
        <div class="col-md-12">
            ...
            <div class="date-input-wrapper">
                <input type="text" name="registration_time" value="{{ old('registration_time',$data['student_registration']['registration_time']) }}" class="form-control" id="registration_time" placeholder="yyyy-mm-dd">
                <i class="fas fa-calendar-alt"></i>
            </div>
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="shipping_address_firstname" value="{{ old('shipping_address_firstname',$data['student_registration']['shipping_address_firstname']) }}" class="form-control" id="shipping_address_firstname">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="shipping_address_lastname" value="{{ old('shipping_address_lastname',$data['student_registration']['shipping_address_lastname']) }}" class="form-control" id="shipping_address_lastname">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="shipping_address_line_1" value="{{ old('shipping_address_line_1',$data['student_registration']['shipping_address_line_1']) }}" class="form-control" id="shipping_address_line_1">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="shipping_address_line_2" value="{{ old('shipping_address_line_2',$data['student_registration']['shipping_address_line_2']) }}" class="form-control" id="shipping_address_line_2">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="shipping_address_city" value="{{ old('shipping_address_city',$data['student_registration']['shipping_address_city']) }}" class="form-control" id="shipping_address_city">
        ...
        <div class="col-md-12">
            ...
            <select id="shipping_address_country_id" value="{{ old('shipping_address_country_id',$data['student_registration']['shipping_address_country_id']) }}" name="shipping_address_country_id" class="form-select">
                     <option value=""><-- Select Country --> </option>
                     @foreach ($data['countries'] as $country)
                <option value="{{ $country->country_id }}" {{ old('country_id',$data['student_registration']['country_id']) == $country->country_id ? 'selected' : '' }}>{{ $country->country_name }} </option>
                @endforeach
        ...
        <div class="col-md-12">
            ...
            <select id="shipping_address_state_id" value="{{ old('shipping_address_state_id',$data['student_registration']['shipping_address_state_id']) }}" name="shipping_address_state_id" class="form-select">
                     <option value=""><-- Select Country --> </option>
                     @foreach ($data['country_to_state_code'] as $state)
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="shipping_address_post_code" value="{{ old('shipping_address_post_code',$data['student_registration']['shipping_address_post_code']) }}" class="form-control" id="shipping_address_post_code">
     ...
     <div class="col-md-3">
            ...
            <select id="shipping_address_mobile_country_code_id" value="{{ old('shipping_address_mobile_country_code_id',$data['student_registration']['shipping_address_mobile_country_code_id']) }}" name="shipping_address_mobile_country_code_id" class="form-select">
                     <option value=""><-- Select Country Code --> </option>
                     @foreach ($data['countries'] as $country)
        ...
        <div class="col-md-9">
            ...
            <input type="text"   name="shipping_address_mobile" value="{{ old('shipping_address_mobile',$data['student_registration']['shipping_address_mobile']) }}" class="form-control" id="shipping_address_mobile">
        ...
        <div class="col-md-12">
            ...
            <input type="text"   name="last_update_datetime" value="{{ old('last_update_datetime',$data['student_registration']['last_update_datetime']) }}" class="form-control" id="last_update_datetime">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            flatpickr("#whatsapp_optout_datetime", {
            ...
            flatpickr("#whatsapp_re_optin_datetime", {
                dateFormat: "Y-m-d h:i:s",
                altInput: true,
                altFormat: "Y-m-d h:i:s",
                allowInput: true, // Allow typing in the input
            ...
            flatpickr("#send_reg_notification_cron_start_datetime", {
                dateFormat: "Y-m-d h:i:s",
                altInput: true,
                altFormat: "Y-m-d h:i:s",
                allowInput: true, // Allow typing in the input
            ...
            flatpickr("#send_reg_notification_cron_end_datetime", {
                dateFormat: "Y-m-d h:i:s",
                altInput: true,
                altFormat: "Y-m-d h:i:s",
                allowInput: true, // Allow typing in the input
            ...
            flatpickr("#zoik_app_registration_sync_cron_start_datetime", {
                dateFormat: "Y-m-d h:i:s",
                altInput: true,
                altFormat: "Y-m-d h:i:s",
                allowInput: true, // Allow typing in the input
            ...
            flatpickr("#zoik_app_registration_sync_cron_end_datetime", {
                dateFormat: "Y-m-d h:i:s",
                altInput: true,
                altFormat: "Y-m-d h:i:s",
                allowInput: true, // Allow typing in the input
            ...
            flatpickr("#last_update_datetime", {
                dateFormat: "Y-m-d h:i:s",
                altInput: true,
                altFormat: "Y-m-d h:i:s",
                allowInput: true, // Allow typing in the input
