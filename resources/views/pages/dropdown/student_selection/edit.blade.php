<x-default-layout>
    ...
    <form action="{{ route('student_selection.update',['sd_selection_id'=>$sd_selection->student_selection_status_id ] ) }}" class="row g-3" method="post" novalidate enctype="multipart/form-data" autocomplete="on" novalidate name="add-user">
        @csrf
        @method('put')
       
        <div class="col-md-12">
            <label for="selection_status" class="form-label">Selection Status</label>
            <input type="selection_status" name="selection_status" value="{{ old('selection_status',$sd_selection->selection_status) }}" class="form-control" id="selection_status">
        ...
        <div class="col-md-12">
            ...
            <input type="bootstrap_class" name="bootstrap_class" value="{{ old('bootstrap_class',$sd_selection->bootstrap_class) }}" class="form-control" id="bootstrap_class">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="selection_status_backend" value="{{ old('selection_status_backend',$sd_selection->selection_status_backend) }}" class="form-control" id="selection_status_backend">
        ...
        <div class="col-md-12">
            ...
            @error('selection_status_description')
