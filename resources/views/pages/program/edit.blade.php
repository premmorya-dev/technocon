<x-default-layout>
    ...
    @section('breadcrumbs')
    {{ Breadcrumbs::render('program.add') }}
    @endsection



    <form action="{{ route('program.update',['program_id'=>$data['program']['program_id']]) }}" onsubmit="return validation();" class="row g-3" method="post" novalidate enctype="multipart/form-data" autocomplete="on" novalidate name="add-user">
        @csrf
        @method('put')

        <div class="col-md-12">
            <label for="program_name" class="form-label">Program Name</label>
            <input type="text" name="program_name" value="{{ old('program_name',$data['program']['program_name']) }}" class="form-control" id="program_name">
            @error('program_name')
        ...
        <div class="col-md-12">
            <label for="registration_seo_url_id" class="form-label">Program Registration Seo Url</label>
            <select id="registration_seo_url_id" name="registration_seo_url_id" class="form-select">
                <option value=""><-- Status --> </option>
                @foreach ($data['program_registration_seo_urls'] as $program_registration_seo_url)
                <option value="{{ $program_registration_seo_url->registration_seo_url_id }}" {{ old('registration_seo_url_id',$data['program']['registration_seo_url_id']) ==  $program_registration_seo_url->registration_seo_url_id ? 'selected' : '' }} >{{ $data['registration_seo_urls_prefix'] ."/" . $program_registration_seo_url->seo_url }}</option>
                @endforeach
            ...
            @error('registration_seo_url_id')
            <div class="alert alert-danger">{{ $errors->first('registration_seo_url_id') }}</div>
            @enderror
        </div>

        <div class="col-md-12">
            <label for="program_location_id" class="form-label">Program Location</label>
            <select id="program_location_id" name="program_location_id" class="form-select">
                <option value=""><-- Status --> </option>
                @foreach ($data['event_program_locations'] as $event_program_location)
                <option value="{{ $event_program_location->program_location_id }}" {{ old('program_location_id',$data['program']['program_location_id']) ==  $event_program_location->program_location_id ? 'selected' : '' }} >{{ 'Venue Name: ' . $event_program_location->venue_name . " | Sub Location: " .  $event_program_location->venue_sub_location_name . " | Capacity: " .  $event_program_location->venue_sub_location_seats_capacity }}</option>
                @endforeach
            ...
            @error('program_location_id')
            <div class="alert alert-danger">{{ $errors->first('program_location_id') }}</div>
            @enderror
        </div>
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="program_code" value="{{ old(generateUniqueCode(4),$data['program']['program_code']) }}" class="form-control" id="program_code">
            @error('program_code')
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="program_name_for_certificate" value="{{ old('program_name_for_certificate',$data['program']['program_name_for_certificate']) }}" class="form-control" id="program_name_for_certificate">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="program_name_sms_dlt" value="{{ old('program_name_sms_dlt',$data['program']['program_name_sms_dlt']) }}" class="form-control" id="program_name_sms_dlt">
        ...
        <div class="col-md-6">
            ...
            <input type="number" name="program_duration" value="{{ old('program_duration',$data['program']['program_duration']) }}" class="form-control" placeholder="Duration" >
        ...
        <div class="col-md-6">
            ...
            <select id="program_duration_time_unit" value="{{ old('program_duration_time_unit') }}" name="program_duration_time_unit" class="form-select input-group-text">
                                        <option value=""><-- Status --> </option>
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="registration_no_prefix" value="{{ old('registration_no_prefix',$data['program']['registration_no_prefix']) }}" class="form-control" id="registration_no_prefix">
        ...
        <div class="col-md-12">
            ...
            <div class="date-input-wrapper">
                <input type="text" name="start_dates" value="{{ old('start_dates',$data['program']['start_dates']) }}" class="form-control" id="start_dates" placeholder="yyyy-mm-dd">
                <i class="fas fa-calendar-alt"></i>
            </div>
            @error('start_dates')
        ...
        <div class="col-md-12">
            ...
            <div class="date-input-wrapper">
                <input type="text" name="end_dates" value="{{ old('end_dates',$data['program']['end_dates']) }}" class="form-control" id="end_dates" placeholder="yyyy-mm-dd">
                <i class="fas fa-calendar-alt"></i>
            </div>
            @error('end_dates')
        ...
        <div class="col-md-12">
            ...
            <div class="time-input-wrapper">
                <input type="text" name="start_time" value="{{ old('start_time',$data['program']['start_time']) }}" class="form-control" id="start_time" placeholder="hh:mm">
        ...
        <div class="col-md-12">
            ...
            <div class="time-input-wrapper">
                <input type="text" name="end_time" value="{{ old('end_time',$data['program']['end_time']) }}" class="form-control" id="end_time" placeholder="hh:mm">
                <i class="fas fa-clock"></i>
            </div>
            @error('end_time')
        ...
        <div class="col-md-12">
            <label for="fees" class="form-label">Fees</label>
                <input type="text" name="fees" value="{{ old('fees',$data['program']['fees']) }}" class="form-control" id="fees">
                @error('fees')
        ...
        <div class="col-md-12">
            ...
            <input type="number" name="tax_rate" value="{{ old('tax_rate',$data['program']['tax_rate']) }}" class="form-control" id="tax_rate">
            @error('tax_rate')
        ...
        <div class="col-md-12">
            ...
            <input type="number" name="payment_gateway_fee_rate" value="{{ old('payment_gateway_fee_rate',$data['program']['payment_gateway_fee_rate']) }}" class="form-control" id="payment_gateway_fee_rate">
        ...
        <div class="col-md-12">
            ...
            <input type="number" name="max_member" value="{{ old('max_member',$data['program']['max_member']) }}" class="form-control" id="max_member">
            @error('max_member')
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="any_special_terms" value="{{ old('any_special_terms',$data['program']['any_special_terms']) }}" class="form-control" id="any_special_terms">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="online_content" value="{{ old('online_content',$data['program']['online_content']) }}" class="form-control" id="online_content">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="content_links" value="{{ old('content_links',$data['program']['content_links']) }}" class="form-control" id="content_links">
            @error('content_links')
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="registration_page_url" value="{{ old('registration_page_url',$data['program']['registration_page_url']) }}" class="form-control" id="registration_page_url">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="registration_page_short_url" value="{{ old('registration_page_short_url',$data['program']['registration_page_short_url']) }}" class="form-control" id="registration_page_short_url">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="registration_page_root_domain" value="{{ old('registration_page_root_domain',$data['program']['registration_page_root_domain']) }}" class="form-control" id="registration_page_root_domain">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_website" value="{{ old('event_website',$data['program']['event_website']) }}" class="form-control" id="event_website">
            @error('event_website')
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="program_details_page_url" value="{{ old('program_details_page_url',$data['program']['program_details_page_url']) }}" class="form-control" id="program_details_page_url">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="program_details_page_short_url" value="{{ old('program_details_page_short_url',$data['program']['program_details_page_short_url']) }}" class="form-control" id="program_details_page_short_url">
        ...
        <div class="col-md-12">
            ...
            <input type="number" name="sms_gateway_id" value="{{ old('sms_gateway_id',$data['program']['sms_gateway_id']) }}" class="form-control" id="sms_gateway_id">
        ...
        <div class="col-md-12">
            ...
            <input type="number" name="registration_sms_template_id" value="{{ old('registration_sms_template_id',$data['program']['registration_sms_template_id']) }}" class="form-control" id="registration_sms_template_id">
        ...
        <div class="col-md-12">
            ...
            <input type="number" name="payment_sms_template_id" value="{{ old('payment_sms_template_id',$data['program']['payment_sms_template_id']) }}" class="form-control" id="payment_sms_template_id">
        ...
        <div class="col-md-12">
            ...
            <input type="number" name="currency_exchange_gateway_id" value="{{ old('currency_exchange_gateway_id',$data['program']['currency_exchange_gateway_id']) }}" class="form-control" id="currency_exchange_gateway_id">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="short_url_domain" value="{{ old('short_url_domain',$data['program']['short_url_domain']) }}" class="form-control" id="short_url_domain">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="contact_us_email" value="{{ old('contact_us_email',$data['program']['contact_us_email']) }}" class="form-control" id="contact_us_email">
        ...
        <div class="col-md-12">
            ...
            <input type="number" name="contact_us_mobile" value="{{ old('contact_us_mobile',$data['program']['contact_us_mobile']) }}" class="form-control" id="contact_us_mobile">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="zoik_app_common_list_uid" value="{{ old('zoik_app_common_list_uid',$data['program']['zoik_app_common_list_uid']) }}" class="form-control" id="zoik_app_common_list_uid">
        ...
        <div class="col-md-12">
            <label for="zoik_app_program_list_uid" class="form-label">Zoik App Program List Uid</label>
            <input type="text" name="zoik_app_program_list_uid" value="{{ old('zoik_app_program_list_uid',$data['program']['zoik_app_program_list_uid']) }}" class="form-control" id="zoik_app_program_list_uid">
            @error('zoik_app_program_list_uid')
            <div class="alert alert-danger">{{ $errors->first('zoik_app_program_list_uid') }}</div>
            @enderror
        </div>
        ...
        <div class="col-md-12">
            <label for="zoik_app_common_list_sync" class="form-label">Zoik App Common List Sync</label>


            <select id="zoik_app_common_list_sync" value="{{ old('zoik_app_common_list_sync') }}" name="zoik_app_common_list_sync" class="form-select">
                <option value=""><-- Select --> </option>
                <option value="Y"  {{ old('zoik_app_common_list_sync',$data['program']['zoik_app_common_list_sync']) == 'Y' ? 'selected' : '' }}>Yes</option>
                <option value="N" {{ old('zoik_app_common_list_sync',$data['program']['zoik_app_common_list_sync']) == 'N' ? 'selected' : '' }}>No</option>
            </select>


            @error('zoik_app_common_list_sync')
            <div class="alert alert-danger">{{ $errors->first('zoik_app_common_list_sync') }}</div>
            @enderror
        </div>
        ...
        <div class="col-md-12">
            <label for="zoik_app_program_list_sync" class="form-label">Zoik App Program List Sync</label>


            <select id="zoik_app_program_list_sync" value="{{ old('zoik_app_program_list_sync') }}" name="zoik_app_program_list_sync" class="form-select">
                <option value=""><-- Select --> </option>
                <option value="Y"  {{ old('zoik_app_program_list_sync',$data['program']['zoik_app_program_list_sync']) == 'Y' ? 'selected' : '' }}>Yes</option>
                <option value="N" {{ old('zoik_app_program_list_sync',$data['program']['zoik_app_program_list_sync']) == 'N' ? 'selected' : '' }}>No</option>
            </select>


            @error('zoik_app_program_list_sync')
            <div class="alert alert-danger">{{ $errors->first('zoik_app_program_list_sync') }}</div>
            @enderror
        </div>
        ...
        <div class="col-md-12">
            <label for="zoik_app_common_list_field_mapping" class="form-label">Zoik App Common List Field Mapping</label><br>

            <textarea name="zoik_app_common_list_field_mapping" id="zoik_app_common_list_field_mapping" class="form-control" rows="4">{{ old('zoik_app_common_list_field_mapping',$data['program']['zoik_app_common_list_field_mapping']) }}</textarea>
            <br>
            @error('zoik_app_common_list_field_mapping')
            <div class="alert alert-danger">{{ $errors->first('zoik_app_common_list_field_mapping') }}</div>
            @enderror
        </div>
        ...
        <div class="col-md-12">
            <label for="zoik_app_program_list_field_mapping" class="form-label">Zoik App Program List Email Field Mapping</label> <br>
            <textarea name="zoik_app_program_list_field_mapping" id="zoik_app_program_list_field_mapping" class="form-control" rows="4">{{ old('zoik_app_program_list_field_mapping',$data['program']['zoik_app_program_list_field_mapping']) }}</textarea>
            @error('zoik_app_program_list_field_mapping')
            <div class="alert alert-danger">{{ $errors->first('zoik_app_program_list_field_mapping') }}</div>
            @enderror
        </div>
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="email_header_banner_url" value="{{ old('email_header_banner_url',$data['program']['email_header_banner_url']) }}" class="form-control" id="email_header_banner_url">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="email_header_banner_alt" value="{{ old('email_header_banner_alt',$data['program']['email_header_banner_alt']) }}" class="form-control" id="email_header_banner_alt">
        ...
        <div class="col-md-12">
            ...
            <input type="number" name="short_url_api_id" value="{{ old('short_url_api_id',$data['program']['short_url_api_id']) }}" class="form-control" id="short_url_api_id">
        ...
        <div class="col-md-12">
            ...
            <input type="number" name="short_url_channel_id" value="{{ old('short_url_channel_id',$data['program']['short_url_channel_id']) }}" class="form-control" id="short_url_channel_id">
       ...
       <div class="col-md-12">
        ...
        <div class="col-md-12">
                        <div class="row">
                                    ...
                                    <div class="col-md-6">   <button type="button" class="btn btn-primary btn-sm add-row float-end mt-3"><i class=" fa-solid fa-plus "></i></button>
                                    </div>
                        </div>
                ...
                <tbody>
                 ...
                 @if ($data['webhook'])
                     ...
                     <tr class="webhook_row{{ $row }}">
                                <td><input type="text" name="webhook[{{ $row }}][url]" class="form-control webhook_url" value="{{ $value['url'] }}" placeholder="Webhook Url {{ $row }}"></td>
                                <td>
                                    <div class="form-check form-switch mt-2">
                                        <input class="form-check-input" value="1" <?php if( isset($value['status']) ) {
                                            echo 'checked';
                                        }
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const paymentLastDatePicker = flatpickr("#payment_last_date", {
                dateFormat: "Y-m-d",
                altInput: true,
                altFormat: "Y-m-d",
                allowInput: true, // Allow typing in the input
