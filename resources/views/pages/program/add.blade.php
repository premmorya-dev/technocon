<x-default-layout>
    ...
    <form action="{{ route('program.store') }}" class="row g-3" method="post" novalidate enctype="multipart/form-data" autocomplete="on" novalidate name="add-user">
        @csrf
        @method('post')

        <div class="col-md-12">
            <label for="program_name" class="form-label">Program Name</label>
            <input type="text" name="program_name" value="{{ old('program_name') }}" class="form-control" id="program_name">
            @error('program_name')
        ...
        <div class="col-md-12">
            ...
            <select id="registration_seo_url_id" name="registration_seo_url_id" class="form-select">
                ...
                <option value="{{ $program_registration_seo_url->registration_seo_url_id }}" {{ old('registration_seo_url_id') ==  $program_registration_seo_url->registration_seo_url_id ? 'selected' : '' }} >{{ $data['registration_seo_urls_prefix'] ."/" . $program_registration_seo_url->seo_url }}</option>
                @endforeach
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="program_code" value="{{ generateUniqueCode(4) }}" class="form-control" id="program_code">
            @error('program_code')
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="program_name_for_certificate" value="{{ old('program_name_for_certificate') }}" class="form-control" id="program_name_for_certificate">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="program_name_sms_dlt" value="{{ old('program_name_sms_dlt') }}" class="form-control" id="program_name_sms_dlt">
        ...
        <div class="col-md-12">
            ...
            <select id="event_program_type_id" name="event_program_type_id" class="form-select">
                ...
                <option value="{{ $program_type->event_program_type_id }}" {{ old('event_program_type_id') ==  $program_type->event_program_type_id ? 'selected' : '' }} >{{ $program_type->event_program_title }}</option>
                @endforeach
        ...
        <div class="col-md-6">
            ...
            <input type="number" name="program_duration" value="{{ old('program_duration') }}" class="form-control" placeholder="Duration" >
        ...
        <div class="col-md-6">
            ...
            <select id="program_duration_time_unit" value="{{ old('program_duration_time_unit') }}" name="program_duration_time_unit" class="form-select input-group-text">
                                        <option value=""><-- Status --> </option>
                                        <option value="Hour" {{ old('program_duration_time_unit') == 'Hour' ? 'selected' : '' }}>Hour</option>
                                        <option value="Day" {{ old('program_duration_time_unit') == 'Day' ? 'selected' : '' }}>Day</option>
                                        <option value="Week" {{ old('program_duration_time_unit') == 'Week' ? 'selected' : '' }}>Week</option>
                                        <option value="Month" {{ old('program_duration_time_unit') == 'Month' ? 'selected' : '' }}>Month</option>
                                        <option value="Year" {{ old('program_duration_time_unit') == 'Year' ? 'selected' : '' }}>Year</option>
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="program_details_page_url" value="{{ old('program_details_page_url') }}" class="form-control" id="program_details_page_url">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="program_details_page_short_url" value="{{ old('program_details_page_short_url') }}" class="form-control" id="program_details_page_short_url">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="zoik_app_program_list_uid" value="{{ old('zoik_app_program_list_uid') }}" class="form-control" id="zoik_app_program_list_uid">
        ...
        <div class="col-md-12">
            ...
            <select id="zoik_app_common_list_sync" value="{{ old('zoik_app_common_list_sync') }}" name="zoik_app_common_list_sync" class="form-select">
                <option value=""><-- Select --> </option>
                <option value="Y"  {{ old('zoik_app_common_list_sync') == 'Y' ? 'selected' : '' }}>Yes</option>
                <option value="N" {{ old('zoik_app_common_list_sync') == 'N' ? 'selected' : '' }}>No</option>
            </select>
        ...
        <div class="col-md-12">
            ...
            <select id="zoik_app_program_list_sync" value="{{ old('zoik_app_program_list_sync') }}" name="zoik_app_program_list_sync" class="form-select">
                <option value=""><-- Select --> </option>
                <option value="Y"  {{ old('zoik_app_program_list_sync') == 'Y' ? 'selected' : '' }}>Yes</option>
                <option value="N" {{ old('zoik_app_program_list_sync') == 'N' ? 'selected' : '' }}>No</option>
            </select>
        ...
        <div class="col-md-12">
            ...
            <textarea name="zoik_app_common_list_field_mapping" id="zoik_app_common_list_field_mapping" class="form-control" rows="4">{{ old('zoik_app_common_list_field_mapping') }}</textarea>
            <br>
        ...
        <div class="col-md-12">
            ...
            <textarea name="zoik_app_program_list_field_mapping" id="zoik_app_program_list_field_mapping" class="form-control" rows="4">{{ old('zoik_app_program_list_field_mapping') }}</textarea>
        ...
        <div class="col-md-12">
            ...
            <select id="program_certificate_id" value="{{ old('program_certificate_id') }}" name="program_certificate_id" class="form-select">
                ...
                <option value="{{ $event_program_certificate->program_certificate_id }}" {{ old('program_certificate_id') == $event_program_certificate->program_certificate_id ? 'selected' : '' }}>{{ $event_program_certificate->certificate_title }}</option>
                @endforeach
                </select>
        ...
        <div class="col-md-12">
            ...
            <textarea name="addional_email_notification" id="addional_email_notification" class="form-control" rows="4">{{ old('addional_email_notification') }}</textarea>
            <br>
