<x-default-layout>
    ...
    <form action="{{ route('event.update',['event_id'=>$event->event_id]) }}" class="row g-3" method="post" novalidate enctype="multipart/form-data" autocomplete="on" novalidate name="add-user">
        @csrf
        @method('put')
        <div class="col-md-12">
            <label for="event_code" class="form-label">Event Code</label>
            <input type="event_code" name="event_code" value="{{ old('event_code',$event->event_code) }}" class="form-control" id="event_code">
            @error('event_code')
        ...
        <div class="col-md-12">
            ...
            <input type="event_backend_name" name="event_backend_name" value="{{ old('event_backend_name',$event->event_backend_name) }}" class="form-control" id="event_backend_name">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_presenting_partner_1" value="{{ old('event_presenting_partner_1',$event->event_presenting_partner_1) }}" class="form-control" id="event_presenting_partner_1">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_presenting_partner_2_association_slug" value="{{ old('event_presenting_partner_2_association_slug',$event->event_presenting_partner_2_association_slug) }}" class="form-control" id="event_presenting_partner_2_association_slug">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_presenting_partner_2" value="{{ old('event_presenting_partner_2',$event->event_presenting_partner_2) }}" class="form-control" id="event_presenting_partner_2">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_presenting_partner_1_association_slug" value="{{ old('event_presenting_partner_1_association_slug',$event->event_presenting_partner_1_association_slug) }}" class="form-control" id="event_presenting_partner_1_association_slug">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_name_prefix" value="{{ old('event_name_prefix',$event->event_name_prefix) }}" class="form-control" id="event_name_prefix">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_name" value="{{ old('event_name',$event->event_name) }}" class="form-control" id="event_name">
            @error('event_name')
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_name_suffix" value="{{ old('event_name_suffix',$event->event_name_suffix) }}" class="form-control" id="event_name_suffix">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_partner_1_association_slug" value="{{ old('event_partner_1_association_slug',$event->event_partner_1_association_slug) }}" class="form-control" id="event_partner_1_association_slug">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_partner_1" value="{{ old('event_partner_1',$event->event_partner_1) }}" class="form-control" id="event_partner_1">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_partner_1_suffix" value="{{ old('event_partner_1_suffix',$event->event_partner_1_suffix) }}" class="form-control" id="event_partner_1_suffix">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_partner_2_association_slug" value="{{ old('event_partner_2_association_slug',$event->event_partner_2_association_slug) }}" class="form-control" id="event_partner_2_association_slug">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_partner_2" value="{{ old('event_partner_2',$event->event_partner_2) }}" class="form-control" id="event_partner_2">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_partner_2_suffix" value="{{ old('event_partner_2_suffix',$event->event_partner_2_suffix) }}" class="form-control" id="event_partner_2_suffix">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_partner_3_association_slug" value="{{ old('event_partner_3_association_slug',$event->event_partner_3_association_slug) }}" class="form-control" id="event_partner_3_association_slug">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_partner_3" value="{{ old('event_partner_3',$event->event_partner_3) }}" class="form-control" id="event_partner_3">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_partner_3_suffix" value="{{ old('event_partner_3_suffix',$event->event_partner_3_suffix) }}" class="form-control" id="event_partner_3_suffix">
        ...
        <div class="col-md-6">
            ...
            <input type="date" name="event_from_date" value="{{ old('event_from_date',$event->event_from_date) }}" class="form-control" id="event_from_date">
        ...
        <div class="col-md-6">
            ...
            <input type="date" name="event_end_date" value="{{ old('event_end_date',$event->event_end_date) }}" class="form-control" id="event_end_date">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="event_url" value="{{ old('event_url',$event->event_url) }}" class="form-control" id="event_url">
            @error('event_url')
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="registration_page_banner_url" value="{{ old('registration_page_banner_url',$event->registration_page_banner_url) }}" class="form-control" id="registration_page_banner_url">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="registration_page_header_main_text" value="{{ old('registration_page_header_main_text',$event->registration_page_header_main_text) }}" class="form-control" id="registration_page_header_main_text">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="registration_page_header_important_notes" value="{{ old('registration_page_header_important_notes',$event->registration_page_header_important_notes) }}" class="form-control" id="registration_page_header_important_notes">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="whatsapp_notification_banner_image_dir_url" value="{{ old('whatsapp_notification_banner_image_dir_url',$event->whatsapp_notification_banner_image_dir_url) }}" class="form-control" id="whatsapp_notification_banner_image_dir_url">
        ...
        <div class="col-md-12">
            ...
            <input type="text" name="whatsapp_notification_banner_image" value="{{ old('whatsapp_notification_banner_image',$event->whatsapp_notification_banner_image) }}" class="form-control" id="whatsapp_notification_banner_image">
